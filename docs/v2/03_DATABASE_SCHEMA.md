...
This is the single source of truth for the core V2 data model. TypeScript interfaces in `apps/mobile-v2` must map exactly to the tables and fields defined here. Where this document and any code disagree, this document wins until formally revised.
